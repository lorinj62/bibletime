...
BT_REGULAR_ICON(icon_bulleted_list, "bulleted_list.svg")
...
BT_REGULAR_ICON(icon_edit_cut, "edit_cut.svg")
BT_REGULAR_ICON(icon_edit_paste, "edit_paste.svg")
...
BT_REGULAR_ICON(icon_highlight, "highlight.svg")
BT_REGULAR_ICON(icon_import, "import.svg")
BT_REGULAR_ICON(icon_info, "info.svg")
BT_REGULAR_ICON(icon_insert_picture, "insert_picture.svg")
BT_REGULAR_ICON(icon_insert_table, "insert_table.svg")
...
BT_REGULAR_ICON(icon_link, "link.svg")
BT_REGULAR_ICON(icon_lock, "lock.svg")
BT_REGULAR_ICON(icon_manual, "manual.svg")
BT_REGULAR_ICON(icon_map, "map.svg")
BT_REGULAR_ICON(icon_numbered_list, "numbered_list.svg")
BT_REGULAR_ICON(icon_open_rich_text_editor, "open_rich_text_editor.svg")
...
BT_REGULAR_ICON(icon_spell_check, "spell_check.svg")
